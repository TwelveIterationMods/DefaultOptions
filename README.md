...
If you're interested in contributing to the mod, you can check out [issues labelled as "help wanted"](https://github.com/TwelveIterations/DefaultOptions/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22).
...
dependencies {
    ...
    // Forge: implementation "curse.maven:default-options-232131:${defaultoptions_file_id}"
...
dependencies {
    ...
    // Forge: implementation "net.blay09.mods:defaultoptions-forge:${defaultoptions_version}"
