...
public class DefaultOptions {
    ...
    public static void preStartGame() {
        ...
        if(!localConfigDefs.exists()) {
            try(InputStreamReader reader = new InputStreamReader(DefaultOptions.class.getResourceAsStream("/assets/defaultoptions/default-localconfig.txt"));
        ...
        if(!exampleConfigDefs.exists()) {
            try(InputStreamReader reader = new InputStreamReader(DefaultOptions.class.getResourceAsStream("/assets/defaultoptions/example-localconfig.txt"));
    ...
    public static boolean backupLocalConfig() {
        ...
        if(localConfigFile.exists()) {
            try (BufferedReader reader = new BufferedReader(new FileReader(localConfigFile));
                ...
                writer.println("# You don't want to change anything in here as it'll get overridden anyways.");
